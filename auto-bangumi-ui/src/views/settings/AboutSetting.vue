...
import { BulbOutlined, CloudOutlined, DashboardOutlined, LayoutOutlined, UngroupOutlined } from '@ant-design/icons-vue';
...
const ApacheLicense = `
   ...
   1. Definitions.
      ...
      transformation or derivation of a Source form, including but
      ...
      separate from, or merely link (or bind by name) to the interfaces of,
   ...
   8. Limitation of Liability. In no event and under no theory of
      liability, whether in tort (including negligence), contract, or
    ...
    <div class="pb-4 flex">
      <a-flex gap="small" wrap="wrap">
        ...
        <div>
          <a-button>
            <UngroupOutlined />
            {{ config.systemInfo.buildTime }}
          </a-button>
        </div>
        <div v-for="item in aboutLinks" :key="item.url">
          <a :href="item.url" target="_blank">
            <a-button>
              <BulbOutlined v-if="item.icon === 'BulbOutlined'" />
              <LayoutOutlined v-else-if="item.icon === 'LayoutOutlined'" />
